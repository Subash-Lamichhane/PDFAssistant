    ...
    :"flex flex-col gap-10 justify-between items-center bg-gray-100 text-gray-700 py-6 pt-10 text-sm"}>
      <div className=" mx-auto flex  justify-evenly items-center w-full ">
        <div className="flex flex-col gap-1 justify-center items-start">
          {/* <Link to="/"> */}
            <div className="text-2xl md:text-4xl font-bold"><span>PDF</span><span className='text-blue-400'>SUMMARIZER</span> </div>
          {/* </Link> */}
          <div className="text-xl text-gray-600">Your Personalized Summarizer.</div>
